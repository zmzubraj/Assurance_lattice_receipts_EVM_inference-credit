...
\newcommand{\statusbanner}{\noindent\colorbox{orange!18}{\parbox{0.965\linewidth}{\centering\small\textbf{DEVELOPMENT DRAFT --- NOT SUBMISSION READY.} Independent novelty, methods, provenance, external reproduction, authorship, venue, and human-approval gates remain open.}}}
\newcolumntype{Y}{>{\raggedright\arraybackslash}X}

\title{\textbf{Assurance-Lattice Receipts for Fail-Closed EVM Inference Credit:}\\A Reproducible Development Study}
\author{Anonymous development draft\\\small Authorship and affiliations pending accountable human approval}
\date{30 August 2026}
...
\begin{figure}[t]
\centering
\resizebox{\linewidth}{!}{\input{../../06-visuals/diagrams/architecture-content.tex}}
...
protocol timestamp (Figure~\ref{fig:workflow}).

\begin{figure}[t]
\centering
\resizebox{0.72\linewidth}{!}{\input{../../06-visuals/diagrams/workflow-content.tex}}
...
\begin{figure}[t]
\centering
\resizebox{0.94\linewidth}{!}{\input{../../06-visuals/figures/reason-distribution-content.tex}}
...
workflow. The finite model and mutation set may be incomplete. The same-owner replay
is not independent replication. Foundry test-call gas is not transaction or
